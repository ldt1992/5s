...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      {{-- -------- Edit Factory ----------- --}}
      <form action="{{ asset('admin/detail/edit').'/'.$detail->id }}" method="post">
      <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Edit <strong><span class="text-aqua">{{$detail-> Detail_Content}}</span></strong></h3>
          </div>
          <!-- /.box-header -->
          ...
          <form class="form-horizontal">
            <div class="box-body">
              <div class="form-group">
                <label for="Fact_Name" class="col-sm-2 control-label">Detail</label>

                <div class="col-sm-10">
                  <input type="text" class="form-control" placeholder="Detail" name="txtName" value="{{$detail-> Detail_Content}}">
                </div>
              </div>
            </div>
            <!-- /.box-body -->
            <div class="box-footer">
              <a href="{{ asset('admin/detail/list') }}" class="btn btn-default"><i class="fa fa-chevron-left"></i> Back</a>
