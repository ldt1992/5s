  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        {{-- -------- Add New Detail ----------- --}}
        <form action="{{ route('postAddDetail')}}" method="post">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Detail</h3>
            </div>
            <!-- /.box-header -->
            ...
            <form class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputFactName" placeholder="Details" name="txtName">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
