...
<!-- Bootstrap 3.3.6 -->
  ...
  <link rel="stylesheet" href="{{asset('public/admin_asset/plugins/jvectormap/jquery-jvectormap-1.2.2.css')}}">
  <!-- Theme style -->
...
<!-- Sparkline -->
<script src="{{ asset('public/admin_asset/plugins/sparkline/jquery.sparkline.min.js') }}"></script>
<!-- jvectormap -->
...
<!-- ChartJS 1.0.1 -->
<script src="{{ asset('public/admin_asset/plugins/chartjs/Chart.min.js') }}"></script>
