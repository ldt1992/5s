...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      {{-- -------- Edit Factory ----------- --}}
      <form action="{{ asset('admin/department/edit').'/'.$department->id }}" method="post">
      <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Edit <strong><span class="text-aqua">{{$department-> Dept_Name}}</span></strong></h3>
          </div>
          <!-- /.box-header -->
          ...
          <form class="form-horizontal">
            <div class="box-body">
              <div class="form-group">
                <label for="Fact_Name" class="col-sm-2 control-label">Department Name</label>

                <div class="col-sm-10">
                  <input type="text" class="form-control" placeholder="Department Name" name="txtName" value="{{$department->Dept_Name}}">
                </div>
              </div>
            </div>
            <!-- /.box-body -->
