  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        {{-- -------- Edit SubSection ----------- --}}
        <form action="{{ asset('admin/subsection/edit').'/'.$subsection->id }}" method="post">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit <strong><span class="text-aqua">{{$subsection-> Subsect_Name}}</span></strong></h3>
            </div>
            ...
            <form class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label for="Fact_Name" class="col-sm-2 control-label">Subsection</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Department Name" name="txtName" value="{{$subsection->Subsect_Name}}">
                  </div>
                </div>
                <hr>
                <div class="form-group">
              ...
              <div class="box-footer">
                <a href="{{ asset('admin/subsection/list') }}" class="btn btn-default"><i class="fa fa-chevron-left"></i> Back</a>
