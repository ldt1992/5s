...
<link rel="stylesheet" href="{{ asset('public/admin_asset/dist/css/AdminLTE.min.css') }}">
  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-md-12">
        {{-- -------- Add New SubSection ----------- --}}
        <form action="{{ route('postAddSubsect')}}" method="post">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Subsection</h3>
            </div>
            <!-- /.box-header -->
            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <hr>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Subsection</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="Subsection" name="txtName">
                  </div>
                </div>
