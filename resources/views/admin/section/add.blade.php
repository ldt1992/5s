  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        {{-- -------- Add New Section ----------- --}}
        <form action="{{ route('postAddSect')}}" method="post">
            ...
            <form class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label for="Section Name" class="col-sm-2 control-label">Section Name</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Section Name" name="txtName">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
                <a href="{{ asset('admin/section/list') }}" class="btn btn-default"><i class="fa fa-chevron-left"></i> Cancel</a>
