      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Factory &nbsp;<a href="{{ asset('admin/factory/add') }}" class="btn btn-warning btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Data</a></h3>
          ...
          <div class="box-body table-responsive no-padding">
            <table class="table table-hover form-delete" data-toggle="dataTable" data-form="deleteForm">
              ...
              <tr>
                <td>{{ $factory -> id }}</td>
                <td>{{ $factory -> Fact_Name }}</td>
                <td class="pull-right">
                  <a href="{{ asset('admin/factory/edit').'/'.$factory-> id}}" class="btn btn-success"><i class="fa fa-pencil"></i> Edit</a>
                  <button data-toggle="modal" data-target="#confirm-delete" data-href="{{ asset('admin/factory/delete').'/'.$factory->id }}" class="btn btn-danger" id="delete-btn"><i class="fa fa-trash"></i> Delete</a>
                </td>
              </tr>
              @endforeach
              {{-- --------- END FACTORY LIST ---------- --}}
