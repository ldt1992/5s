  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        {{-- -------- Add New Factory ----------- --}}
        <form action="{{ route('postAddFactory')}}" method="post">
            ...
            <form class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label for="Fact_Name" class="col-sm-2 control-label">Name</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputFactName" placeholder="Factory Name" name="txtName">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
